...
func (c *apiGatewayClient) GetMediaUploadURL(ctx context.Context, in *GetMediaUploadUrlRequest, opts ...grpc.CallOption) (*GetMediaUploadUrlResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api_gateway.v1.ApiGateway/GetMediaUploadURL", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiGatewayClient) ConfirmUploadMedia(ctx context.Context, in *ConfirmUploadMediaRequest, opts ...grpc.CallOption) (*ConfirmUploadMediaResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api_gateway.v1.ApiGateway/ConfirmUploadMedia", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiGatewayClient) Like(ctx context.Context, in *LikeRequest, opts ...grpc.CallOption) (*LikeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api_gateway.v1.ApiGateway/Like", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiGatewayClient) SuperLike(ctx context.Context, in *SuperLikeRequest, opts ...grpc.CallOption) (*SuperLikeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api_gateway.v1.ApiGateway/SuperLike", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiGatewayClient) Dislike(ctx context.Context, in *DislikeRequest, opts ...grpc.CallOption) (*DislikeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api_gateway.v1.ApiGateway/Dislike", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiGatewayClient) Save(ctx context.Context, in *SaveRequest, opts ...grpc.CallOption) (*SaveResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api_gateway.v1.ApiGateway/Save", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiGatewayClient) WhoLikedMe(ctx context.Context, in *WhoLikedMeRequest, opts ...grpc.CallOption) (*WhoLikedMeResponse, error) {
	out := new(WhoLikedMeResponse)
	err := c.cc.Invoke(ctx, "/api_gateway.v1.ApiGateway/WhoLikedMe", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiGatewayClient) GetSaved(ctx context.Context, in *GetSavedRequest, opts ...grpc.CallOption) (*GetSavedResponse, error) {
	out := new(GetSavedResponse)
	err := c.cc.Invoke(ctx, "/api_gateway.v1.ApiGateway/GetSaved", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedApiGatewayServer) WhoLikedMe(context.Context, *WhoLikedMeRequest) (*WhoLikedMeResponse, error) {
...
func _ApiGateway_GetMediaUploadURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api_gateway.v1.ApiGateway/GetMediaUploadURL",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ApiGateway_ConfirmUploadMedia_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api_gateway.v1.ApiGateway/ConfirmUploadMedia",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ApiGateway_Like_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api_gateway.v1.ApiGateway/Like",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ApiGateway_SuperLike_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api_gateway.v1.ApiGateway/SuperLike",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ApiGateway_Dislike_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api_gateway.v1.ApiGateway/Dislike",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ApiGateway_Save_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api_gateway.v1.ApiGateway/Save",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ApiGateway_WhoLikedMe_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WhoLikedMeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiGatewayServer).WhoLikedMe(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api_gateway.v1.ApiGateway/WhoLikedMe",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiGatewayServer).WhoLikedMe(ctx, req.(*WhoLikedMeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ApiGateway_GetSaved_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSavedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiGatewayServer).GetSaved(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api_gateway.v1.ApiGateway/GetSaved",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiGatewayServer).GetSaved(ctx, req.(*GetSavedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ApiGateway_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ApiGateway_WhoLikedMe_Handler,
		},
		{
			MethodName: "GetSaved",
