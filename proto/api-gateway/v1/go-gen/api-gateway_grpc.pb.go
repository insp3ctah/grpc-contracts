...
const (
	...
	ApiGateway_WhoLikedMe_FullMethodName         = "/api_gateway.v1.ApiGateway/WhoLikedMe"
	ApiGateway_GetSaved_FullMethodName           = "/api_gateway.v1.ApiGateway/GetSaved"
	ApiGateway_GetMatch_FullMethodName           = "/api_gateway.v1.ApiGateway/GetMatch"
)
...
func (c *apiGatewayClient) WhoLikedMe(ctx context.Context, in *WhoLikedMeRequest, opts ...grpc.CallOption) (*WhoLikedMeResponse, error) {
	...
	err := c.cc.Invoke(ctx, ApiGateway_WhoLikedMe_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiGatewayClient) GetSaved(ctx context.Context, in *GetSavedRequest, opts ...grpc.CallOption) (*GetSavedResponse, error) {
	...
	err := c.cc.Invoke(ctx, ApiGateway_GetSaved_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiGatewayClient) GetMatch(ctx context.Context, in *GetMatchRequest, opts ...grpc.CallOption) (*GetMatchResponse, error) {
	...
	err := c.cc.Invoke(ctx, ApiGateway_GetMatch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ApiGateway_WhoLikedMe_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApiGateway_WhoLikedMe_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ApiGateway_GetSaved_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApiGateway_GetSaved_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ApiGateway_GetMatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApiGateway_GetMatch_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
